...
class TestDatabaseRollback:
    ...
    def test_process_item_rollback_on_error(
        self, mock_ai, mock_storage, mock_session_cls
    ):
...
class TestConcurrentTasks:
    ...
    def test_concurrent_processing_different_items(
        ...
        mock_db1.query.return_value.filter.return_value.first.side_effect = [
            item1,
            media1,
        ]
        mock_db2.query.return_value.filter.return_value.first.side_effect = [
            item2,
            media2,
        ]
        ...
        mock_ai.ocr_image = AsyncMock(
            return_value={"text": "Item 1", "confidence": 0.99}
        )
        ...
        mock_ai.ocr_image = AsyncMock(
            return_value={"text": "Item 2", "confidence": 0.99}
        )
